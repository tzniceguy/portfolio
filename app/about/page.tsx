				...
				<div className="relative">
					...
					<div className="relative  rounded-lg p-8 shadow-xs border ">
						...
						<p className="text-xl leading-relaxed">
							Hi there! I am <span className="font-semibold">Joe</span>, a
							software developer from Tanzania who loves to build things with
							modern technologies.
						</p>
					</div>
				</div>
				...
				<div className="bg-linear-to-br rounded-xl p-8 shadow-xs border ">
					...
					<div className="leading-relaxed space-y-6">
						<div className="prose prose-lg max-w-none">
							<p className="text-lg">
								I am a full-stack engineer from Tanzania, specializing in
								TypeScript and Python development. My journey in programming
								began in 2019 as a self-taught developer, learning from amazing
								educators on YouTube like{" "}
								<a
